...
function calc() {
  ...
  function getDinamicInformation(selictor) {
    var input = document.querySelector(selictor);
...
function timer(id, deadLine) {
  ...
  function setClock(selector, endtime) {
    ...
    timeInterval = setInterval(updateClock, 1000); // убирает мигание при обновлении страницы
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__.default)('.timer', '2020-12-31');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__.default)();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_1__.default)();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_3__.default)('formm', modalTimerId);
