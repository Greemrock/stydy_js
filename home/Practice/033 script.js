...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let promo__bg = document.querySelector(".promo__bg"),
    ...
    btn_add = add.querySelector("button"),
    // c_box = add.querySelector('.yes').previousElementSibling,
    c_box = add.querySelector('[type="checkbox"]'),
  ...
  btn_add.addEventListener("click", (event) => {
    ...
    if (newFilm) {
      ...
      list_film(movieDB.movies, movieList);
    }
